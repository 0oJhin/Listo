...
class _ProjectScreenState extends State<ProjectScreen> {
  ...
  Future<void> _load() async {
    final idProjeto = widget.projeto.idProjeto;
  ...
  Future<void> _open(ListaModel list) async {
    await Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => ListScreen(lista: list, idPessoa: widget.idPessoa),
      ),
    );
    await _load();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text(widget.projeto.nomeProjeto)),
            ...
            ..._lists.map(
              (list) => Padding(
                ...
                child: ProjectListCard(
                  ...
                  onOpen: () => _open(list),
                  onAction: (action) => _handleAction(list, action),
                ),
              ),
            ),
          ],
